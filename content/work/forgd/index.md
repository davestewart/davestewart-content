...
[Forgd](https://forgd.com) provides tools and services to help blockchain projects launch and manage their token. I joined in March 2024 as a Senior Frontend / UI engineer, with the company scaling rapidly over the next 18 months.
...
This involved working hand-in-glove with Forgd's designer [Lucas Lopez](https://www.lucaslopezdesign.com/forgd) to implement his detailed Figma designs for a wide range of data-driven components, forms and charts, so page designs could be quickly and reliably realised by the application team.
...
- [Forgd](https://forgd.com)
- [Lucas Lopez](https://www.lucaslopezdesign.com/forgd)

Resources:

- [Modular site architecture with Nuxt layers
  ](https://davestewart.co.uk/blog/nuxt-layers/)
- [Nuxt Layer Utils](https://github.com/davestewart/nuxt-layers-utils)
